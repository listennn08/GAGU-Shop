...
const NUXI_API_UUID = 'dd62b88f-6f23-42a4-8551-b1cb4552bb3e'
const Request = axios.create({
  timeout: 30000,
  baseURL: `https://course-ec-api.hexschool.io/api/${NUXI_API_UUID}/ec/`,
})
...
export const updateCart = (product, quantity) =>
  Request.patch('shopping', {
    product,
    quantity,
  })
export const deleteCart = (product) =>
  product
    ? Request.delete(`shopping/${product}`)
    : Request.delete('shopping/all/product')

export const checkCoupon = (code) =>
  Request.post('coupon/search', {
    code,
  })
